...
* `nodejs-dev-x1-app` – アプリケーションのサンプルコードと Dockerfile を格納  
* `nodejs-dev-x1-manifest` – K8s マニフェストと CI/CD 関連ファイルを格納  
...
```bash
git clone https://github.com/rhdh-skitamura-org/nodejs-dev-x1-app.git
cd nodejs-dev-x1-app
